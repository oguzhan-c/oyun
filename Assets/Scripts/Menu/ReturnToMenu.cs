...
public class ReturnToMenu : MonoBehaviour
{
    ...
    IEnumerator ReturnToMainMenu()
    {
        ...
        if (RewardTrack.timmyCount == 7 || RewardTrack.mouseyCount == 7 || RewardTrack.doozyCount == 7 || RewardTrack.claireCount == 7 || RewardTrack.bossCount == 7 || RewardTrack.arissaCount == 7)
        {
            ...
            if (RewardTrack.arissaCount == 7)
            {
                RewardTrack.whichChar = 8;
                SceneManager.LoadScene(13);
            }
