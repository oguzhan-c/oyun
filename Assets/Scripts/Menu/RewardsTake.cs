...
public class RewardsTake : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (charImport == 8)
        {
            charRunCount = RewardTrack.arissaCount;
            rewardName.GetComponent<Text>().text = "> ARISSA REWARD TRIGGERED! <";
            PlayerPrefs.SetInt("ArissaPlay", 0);
        }
        if (charImport == 9)
        {
            charRunCount = RewardTrack.michelleCount;
            rewardName.GetComponent<Text>().text = "> MICHELLE REWARD TRIGGERED! <";
    ...
    IEnumerator BackToMenu()
    {
        ...
        ArissaTrack.isOn = false;
        MichelleTrack.isOn = false; 
